...
void Output_DrawScreenBox(int32_t sx, int32_t sy, int32_t w, int32_t h)
{
    ...
    // Bottom
    Output_DrawScreenLine(w + sx + 1, h + sy + 1, -w - 3, 0, rgb_border_dark);
    Output_DrawScreenLine(w + sx, h + sy, -w - 1, 0, rgb_border_light);
    ...
    // // Bottom
    // Output_DrawScreenLine(w + sx + 1, h + sy + 1, -w - 3, 0,
    // rgb_border_light); Output_DrawScreenLine(w + sx, h + sy, -w - 1, 0,
    // rgb_border_dark);
}

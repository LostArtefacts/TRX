...
typedef enum {
    ...
    GSI_HEADING_GAME_OVER,
    GSI_HEADING_OPTION,
    GSI_HEADING_ITEMS,

    GSI_PASSPORT_SELECT_LEVEL,
    GSI_PASSPORT_SELECT_MODE,
    GSI_PASSPORT_MODE_NEW_GAME,
    GSI_PASSPORT_MODE_NEW_GAME_PLUS,
    GSI_PASSPORT_NEW_GAME,
    GSI_PASSPORT_LOAD_GAME,
    GSI_PASSPORT_SAVE_GAME,
    GSI_PASSPORT_EXIT_GAME,
    GSI_PASSPORT_EXIT_TO_TITLE,

    GSI_DETAIL_SELECT_DETAIL,
    GSI_DETAIL_LEVEL_HIGH,
    GSI_DETAIL_LEVEL_MEDIUM,
    GSI_DETAIL_LEVEL_LOW,
    GSI_DETAIL_PERSPECTIVE_FMT,
    GSI_DETAIL_BILINEAR_FMT,
    GSI_DETAIL_VIDEO_MODE_FMT,

    GSI_SOUND_SET_VOLUMES,

    GSI_CONTROL_DEFAULT_KEYS,
    GSI_CONTROL_USER_KEYS,

    GSI_KEYMAP_RUN,
    GSI_KEYMAP_BACK,
    GSI_KEYMAP_LEFT,
    GSI_KEYMAP_RIGHT,
    GSI_KEYMAP_STEP_LEFT,
    GSI_KEYMAP_STEP_RIGHT,
    GSI_KEYMAP_WALK,
    GSI_KEYMAP_JUMP,
    GSI_KEYMAP_ACTION,
    GSI_KEYMAP_DRAW_WEAPON,
    GSI_KEYMAP_LOOK,
    GSI_KEYMAP_ROLL,
    GSI_KEYMAP_INVENTORY,

    GSI_STATS_TIME_TAKEN_FMT,
    GSI_STATS_SECRETS_FMT,
    GSI_STATS_PICKUPS_FMT,
    GSI_STATS_KILLS_FMT,

    GSI_MISC_ON,
    GSI_MISC_OFF,
    GSI_MISC_EMPTY_SLOT_FMT,
    GSI_MISC_DEMO_MODE,

    GSI_INV_ITEM_MEDI,
    GSI_INV_ITEM_BIG_MEDI,

    GSI_INV_ITEM_PUZZLE1,
    GSI_INV_ITEM_PUZZLE2,
    GSI_INV_ITEM_PUZZLE3,
    GSI_INV_ITEM_PUZZLE4,
    ...
    GSI_INV_ITEM_PICKUP1,
    GSI_INV_ITEM_PICKUP2,
    GSI_INV_ITEM_LEADBAR,
    GSI_INV_ITEM_SCION,

    GSI_INV_ITEM_PISTOLS,
    GSI_INV_ITEM_SHOTGUN,
    GSI_INV_ITEM_MAGNUM,
    GSI_INV_ITEM_UZI,
    GSI_INV_ITEM_GRENADE,

    GSI_INV_ITEM_PISTOL_AMMO,
    GSI_INV_ITEM_SHOTGUN_AMMO,
    GSI_INV_ITEM_MAGNUM_AMMO,
    GSI_INV_ITEM_UZI_AMMO,

    GSI_INV_ITEM_COMPASS,
    GSI_INV_ITEM_GAME,
    GSI_INV_ITEM_DETAILS,
    GSI_INV_ITEM_SOUND,
    GSI_INV_ITEM_CONTROLS,
    GSI_INV_ITEM_GAMMA,
    GSI_INV_ITEM_LARAS_HOME,

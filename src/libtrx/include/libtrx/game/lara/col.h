...
extern void Lara_Col_Turn(ITEM *item, COLL_INFO *coll);
extern void Lara_Col_Death(ITEM *item, COLL_INFO *coll);
...
extern void Lara_Col_Empty(ITEM *item, COLL_INFO *coll);

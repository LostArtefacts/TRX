...
const CONFIG_OPTION g_ConfigOptionMap[] = {
    ...
    { .name = "anisotropy_filter",              .type = COT_FLOAT,  .target = &g_Config.rendering.anisotropy_filter,         .default_value = &(float){16.0f}},
    ...
    { .name = "render_mode",                    .type = COT_INT32,  .target = &g_Config.rendering.render_mode,               .default_value = &(int32_t){GFX_RM_LEGACY}},
    { .name = "enable_fullscreen",              .type = COT_BOOL,   .target = &g_Config.rendering.enable_fullscreen,         .default_value = &(bool){true}},
    { .name = "enable_maximized",               .type = COT_BOOL,   .target = &g_Config.rendering.enable_maximized,          .default_value = &(bool){true}},
    { .name = "window_x",                       .type = COT_INT32,  .target = &g_Config.rendering.window_x,                  .default_value = &(int32_t){-1}},
    { .name = "window_y",                       .type = COT_INT32,  .target = &g_Config.rendering.window_y,                  .default_value = &(int32_t){-1}},
    { .name = "window_width",                   .type = COT_INT32,  .target = &g_Config.rendering.window_width,              .default_value = &(int32_t){-1}},
    { .name = "window_height",                  .type = COT_INT32,  .target = &g_Config.rendering.window_height,             .default_value = &(int32_t){-1}},
    { .name = "texture_filter",                 .type = COT_INT32,  .target = &g_Config.rendering.texture_filter,            .default_value = &(int32_t){GFX_TF_BILINEAR}},
    { .name = "fbo_filter",                     .type = COT_INT32,  .target = &g_Config.rendering.fbo_filter,                .default_value = &(int32_t){GFX_TF_NN}},
    { .name = "enable_perspective_filter",      .type = COT_BOOL,   .target = &g_Config.rendering.enable_perspective_filter, .default_value = &(bool){true}},
    { .name = "enable_vsync",                   .type = COT_BOOL,   .target = &g_Config.rendering.enable_vsync,              .default_value = &(bool){true}},
    ...
    { .name = "layout",                         .type = COT_INT32,  .target = &g_Config.input.layout,                        .default_value = &(int32_t){0}},
    { .name = "cntlr_layout",                   .type = COT_INT32,  .target = &g_Config.input.cntlr_layout,                  .default_value = &(int32_t){0}},
    { .name = "brightness",                     .type = COT_FLOAT,  .target = &g_Config.brightness,                          .default_value = &(float){DEFAULT_BRIGHTNESS}},
    { .name = "text_scale",                     .type = COT_DOUBLE, .target = &g_Config.ui.text_scale,                       .default_value = &(double){DEFAULT_UI_SCALE}},
    { .name = "bar_scale",                      .type = COT_DOUBLE, .target = &g_Config.ui.bar_scale,                        .default_value = &(double){DEFAULT_UI_SCALE}},
    { .name = "new_game_plus_unlock",           .type = COT_BOOL,   .target = &g_Config.profile.new_game_plus_unlock,        .default_value = &(bool){false}},
    // clang-format on

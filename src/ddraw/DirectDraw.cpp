...
HRESULT WINAPI DirectDraw::CreatePalette(
...
HRESULT WINAPI DirectDraw::CreateSurface(
...
HRESULT WINAPI DirectDraw::EnumDisplayModes(
...
HRESULT WINAPI DirectDraw::EnumSurfaces(
    DWORD dwFlags, LPDDSURFACEDESC lpDDSurfaceDesc, LPVOID lpContext,
...
HRESULT WINAPI
DirectDraw::GetCaps(LPDDCAPS lpDDDriverCaps, LPDDCAPS lpDDHELCaps)
{
...
HRESULT WINAPI
DirectDraw::SetDisplayMode(DWORD dwWidth, DWORD dwHeight, DWORD dwBPP)
{

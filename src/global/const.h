...
#define LARA_AIR 3600

#define LARA_TURN_UNDO (2 * PHD_DEGREE) // = 364
#define LARA_TURN_RATE ((PHD_DEGREE / (8*ANIM_SCALE)) + LARA_TURN_UNDO) // = 409
...
#define LARA_LEAN_RATE 273 / ANIM_SCALE
...
#define DAMAGE_LENGTH (14 *ANIM_SCALE)
#define NO_ITEM (-1)
#define NO_CAMERA (-1)
...
#define OPEN_FRAMES (64)
#define CLOSE_FRAMES (64)
#define RINGSWITCH_FRAMES (96)
#define ROTATE_DURATION (48 / ANIM_SCALE)
#define SELECTING_FRAMES (64 / ANIM_SCALE)
...
#define VIEW_FAR (0x14 * 0x400*ANIM_SCALE)
#define DEPTH_Q_END (20 * 1024*ANIM_SCALE)

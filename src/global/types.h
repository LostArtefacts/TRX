...
typedef enum LARA_ANIMATION_FRAME {
    AF_VAULT12 = 759 *ANIM_SCALE,
    AF_VAULT34 = 614 *ANIM_SCALE,
    AF_FASTFALL = 481 *ANIM_SCALE,
    AF_STOP = 185 *ANIM_SCALE,
    AF_FALLDOWN = 492 *ANIM_SCALE,
    AF_STOP_LEFT = 58 *ANIM_SCALE,
    AF_STOP_RIGHT = 74 *ANIM_SCALE,
    AF_HITWALLLEFT = 800 *ANIM_SCALE,
    AF_HITWALLRIGHT = 815 *ANIM_SCALE,
    AF_RUNSTEPUP_LEFT = 837 *ANIM_SCALE,
    AF_RUNSTEPUP_RIGHT = 830 *ANIM_SCALE,
    AF_WALKSTEPUP_LEFT = 844 *ANIM_SCALE,
    AF_WALKSTEPUP_RIGHT = 858 *ANIM_SCALE,
    AF_WALKSTEPD_LEFT = 887 *ANIM_SCALE,
    AF_WALKSTEPD_RIGHT = 874 *ANIM_SCALE,
    AF_BACKSTEPD_LEFT = 899 *ANIM_SCALE,
    AF_BACKSTEPD_RIGHT = 930 *ANIM_SCALE,
    AF_LANDFAR = 358 *ANIM_SCALE,
    AF_GRABLEDGE = 1493 *ANIM_SCALE,
    AF_GRABLEDGE_OLD = 621 *ANIM_SCALE,
    AF_SWIMGLIDE = 1431 *ANIM_SCALE,
    AF_FALLBACK = 1473 *ANIM_SCALE,
    AF_HANG = 1514 *ANIM_SCALE,
    AF_HANG_OLD = 642 *ANIM_SCALE,
    AF_STARTHANG = 1505 *ANIM_SCALE,
    AF_STARTHANG_OLD = 634 *ANIM_SCALE,
    AF_STOPHANG = 448 *ANIM_SCALE,
    AF_SLIDE = 1133 *ANIM_SCALE,
    AF_SLIDEBACK = 1677 *ANIM_SCALE,
    AF_TREAD = 1736 *ANIM_SCALE,
    AF_SURFTREAD = 1937 *ANIM_SCALE,
    AF_SURFDIVE = 2041 *ANIM_SCALE,
    AF_SURFCLIMB = 1849 *ANIM_SCALE,
    AF_JUMPIN = 1895 *ANIM_SCALE,
    AF_ROLL = 3857 *ANIM_SCALE,
    AF_RBALL_DEATH = 3561 *ANIM_SCALE,
    AF_SPIKE_DEATH = 3887 *ANIM_SCALE,
    AF_GRABLEDGEIN = 3974 *ANIM_SCALE,
    AF_PPREADY = 2091 *ANIM_SCALE,
    AF_PICKUP = 3443 *ANIM_SCALE,
    AF_PICKUP_UW = 2970 *ANIM_SCALE,
    AF_PICKUPSCION = 44 *ANIM_SCALE,
    AF_USEPUZZLE = 3372 *ANIM_SCALE,
} LARA_ANIMATION_FRAME;

typedef enum LARA_SHOTGUN_ANIMATION_FRAME {
    AF_SG_AIM = 0 *ANIM_SCALE,
    AF_SG_DRAW = 13 *ANIM_SCALE,
    AF_SG_RECOIL = 47 *ANIM_SCALE,
    AF_SG_UNDRAW = 80 *ANIM_SCALE,
    AF_SG_UNAIM = 114 *ANIM_SCALE,
    AF_SG_END = 127 *ANIM_SCALE,
} LARA_SHOTGUN_ANIMATION_FRAME;

typedef enum LARA_GUN_ANIMATION_FRAME {
    AF_G_AIM = 0 *ANIM_SCALE,
    AF_G_AIM_L = 4 *ANIM_SCALE,
    AF_G_DRAW1 = 5 *ANIM_SCALE,
    AF_G_DRAW1_L = 12 *ANIM_SCALE,
    AF_G_DRAW2 = 13 *ANIM_SCALE,
    AF_G_DRAW2_L = 23 *ANIM_SCALE,
    AF_G_RECOIL = 24 *ANIM_SCALE,

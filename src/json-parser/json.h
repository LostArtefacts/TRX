...
json_weak int json_hexadecimal_value(
...
json_weak void json_parse_value(
    struct json_parse_state_s* state, int is_global_object,
    struct json_value_s* value);

json_weak void json_parse_string(
...
json_weak void json_parse_object(
    struct json_parse_state_s* state, int is_global_object,
...
json_weak void json_parse_number(
...
json_weak void json_extract_copy_value(
...
json_weak int json_write_minified_get_value_size(
...
json_weak int json_write_minified_get_object_size(
...
json_weak char* json_write_pretty_object(

...
// placeholder, and one a translator wrote a bare percent sign into. The real
// one is loaded from cfg/base_strings.json5 and its translations; what is under
// test is what the surface does with these and with a key it does not have.

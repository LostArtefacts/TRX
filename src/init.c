...
GAMEFLOW_DEFAULT_STRING g_GameFlowDefaultStrings[] = {
    ...
    { GS_CONTROL_CUSTOMIZE, "Customize Controls" },
    { GS_CONTROL_KEYBOARD, "Keyboard" },
    { GS_CONTROL_CONTROLLER, "Controller" },
    ...
    { GS_CONTROL_RESET_DEFAULTS_KEY, "Reset All: Hold R" },
    { GS_CONTROL_UNBIND_KEY, "Unbind: Hold Backspace" },
    { GS_CONTROL_RESET_DEFAULTS_BTN, "Reset All: Hold %s" },
    { GS_CONTROL_UNBIND_BTN, "Unbind: Hold %s" },
    { GS_KEYMAP_RUN, "Run" },
    { GS_KEYMAP_BACK, "Back" },
    { GS_KEYMAP_LEFT, "Left" },

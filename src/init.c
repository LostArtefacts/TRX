...
GAMEFLOW_DEFAULT_STRING g_GameFlowDefaultStrings[] = {
    ...
    { GS_STATS_DIFFICULTY_FMT, "DIFFICULTY %s" },
    ...
    { GS_DIFFICULTY_3, "Normal" },
    { GS_DIFFICULTY_4, "Hard" },
    { GS_DIFFICULTY_5, "Very Hard" },
    { GS_DIFFICULTY_6, "Extreme" },
    { GS_DIFFICULTY_7, "Impossible" },
    { 0, NULL },
};

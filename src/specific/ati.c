...
// clang-format off
#define ATI3DCIF_GetInfo_lib                ((C3D_EC (__stdcall **)(PC3D_3DCIFINFO info))0x00459CF4)
#define ATI3DCIF_TextureReg_lib             ((C3D_EC (__stdcall **)(C3D_PTMAP ptmapToReg, C3D_PHTX phtmap))0x00459CF8)
#define ATI3DCIF_TextureUnreg_lib           ((C3D_EC (__stdcall **)(C3D_HTX htxToUnreg))0x00459CFC)
...
C3D_EC InitATI3DCIF()
{
    ...
    *ATI3DCIF_GetInfo_lib =
    ...
    if (!ATI3DCIF_GetInfo_lib) {
        ...
        *ATI3DCIF_GetInfo_lib =
            (C3D_EC(__stdcall *)(C3D_3DCIFINFO *))ATI3DCIF_NullSub;
    ...
    *ATI3DCIF_TextureReg_lib =
    ...
    if (!ATI3DCIF_TextureReg_lib) {
        ...
        *ATI3DCIF_TextureReg_lib =
            (C3D_EC(__stdcall *)(C3D_PTMAP, C3D_PHTX))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }

    *ATI3DCIF_TextureUnreg_lib = *(C3D_EC(__stdcall **)(C3D_HTX))GetProcAddress(
        HATI3DCIFModule, "ATI3DCIF_TextureUnreg_lib");
    if (!ATI3DCIF_TextureUnreg_lib) {
        LOG_ERROR("cannot find ATI3DCIF_TextureUnreg_lib");
        *ATI3DCIF_TextureUnreg_lib =
            (C3D_EC(__stdcall *)(C3D_HTX))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_TexturePaletteCreate_lib =
    ...
    if (!ATI3DCIF_TexturePaletteCreate_lib) {
        ...
        *ATI3DCIF_TexturePaletteCreate_lib = (C3D_EC(__stdcall *)(
            C3D_ECI_TMAP_TYPE, void *, C3D_PHTXPAL))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_TexturePaletteDestroy_lib =
    ...
    if (!ATI3DCIF_TexturePaletteDestroy_lib) {
        ...
        *ATI3DCIF_TexturePaletteDestroy_lib =
            (C3D_EC(__stdcall *)(C3D_HTXPAL))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_TexturePaletteAnimate =
    ...
    if (!ATI3DCIF_TexturePaletteAnimate) {
        ...
        *ATI3DCIF_TexturePaletteAnimate = (C3D_EC(__stdcall *)(
            C3D_HTXPAL, C3D_UINT32, C3D_UINT32,
            C3D_PPALETTENTRY))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_ContextDestroy_lib = *(C3D_EC(__stdcall **)(
    ...
    if (!ATI3DCIF_ContextDestroy_lib) {
        ...
        *ATI3DCIF_ContextDestroy_lib =
            (C3D_EC(__stdcall *)(C3D_HRC))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_ContextSetState_lib =
    ...
    if (!ATI3DCIF_ContextSetState_lib) {
        ...
        *ATI3DCIF_ContextSetState_lib = (C3D_EC(__stdcall *)(
            C3D_HRC, C3D_ERSID, C3D_PRSDATA))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }

    *ATI3DCIF_RenderBegin_lib = *(C3D_EC(__stdcall **)(C3D_HRC))GetProcAddress(
        HATI3DCIFModule, "ATI3DCIF_RenderBegin_lib");
    if (!ATI3DCIF_RenderBegin_lib) {
        LOG_ERROR("cannot find ATI3DCIF_RenderBegin_lib");
        *ATI3DCIF_RenderBegin_lib =
            (C3D_EC(__stdcall *)(C3D_HRC))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_RenderSwitch = *(C3D_EC(__stdcall **)(C3D_HRC))GetProcAddress(
        HATI3DCIFModule, "ATI3DCIF_RenderSwitch_lib");
    if (!ATI3DCIF_RenderSwitch) {
        LOG_ERROR("cannot find ATI3DCIF_RenderSwitch_lib");
        *ATI3DCIF_RenderSwitch = (C3D_EC(__stdcall *)(C3D_HRC))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_RenderPrimStrip_lib =
    ...
    if (!ATI3DCIF_RenderPrimStrip_lib) {
        ...
        *ATI3DCIF_RenderPrimStrip_lib =
            (C3D_EC(__stdcall *)(C3D_VSTRIP, C3D_UINT32))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }
    ...
    *ATI3DCIF_RenderPrimList_lib =
    ...
    if (!ATI3DCIF_RenderPrimList_lib) {
        ...
        *ATI3DCIF_RenderPrimList_lib =
            (C3D_EC(__stdcall *)(C3D_VLIST, C3D_UINT32))ATI3DCIF_NullSub;
        result = C3D_EC_GENFAIL;
    }

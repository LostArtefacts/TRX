...
static __attribute__((constructor)) void M_Init(void)
{
    ...
    ENUM_MAP(INPUT_LAYOUT, INPUT_LAYOUT_DEFAULT, "default");
    ENUM_MAP(INPUT_LAYOUT, INPUT_LAYOUT_CUSTOM_1, "custom_1");
    ENUM_MAP(INPUT_LAYOUT, INPUT_LAYOUT_CUSTOM_2, "custom_2");
    ENUM_MAP(INPUT_LAYOUT, INPUT_LAYOUT_CUSTOM_3, "custom_3");

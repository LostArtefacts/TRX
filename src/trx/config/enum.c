...
{
    ENUM_MAP(ASPECT_MODE, AM_ANY, "any");
    ENUM_MAP(ASPECT_MODE, AM_4_3, "4:3");
    ENUM_MAP(ASPECT_MODE, AM_16_9, "16:9");
    ENUM_MAP(ASPECT_MODE, AM_16_10, "16:10");
    ...
    ENUM_MAP(MUSIC_LOAD_CONDITION, MUSIC_LOAD_NEVER, "never");
    ENUM_MAP(MUSIC_LOAD_CONDITION, MUSIC_LOAD_NON_AMBIENT, "non-ambient");
    ENUM_MAP(MUSIC_LOAD_CONDITION, MUSIC_LOAD_ALWAYS, "always");
    ...
    ENUM_MAP(BAR_SHOW_MODE, BSM_NEVER, "never");
    ENUM_MAP(BAR_SHOW_MODE, BSM_ALWAYS, "always");
    ENUM_MAP(BAR_SHOW_MODE, BSM_BOSS_ONLY, "boss-only");

    ENUM_MAP(BAR_LOCATION, BL_TOP_LEFT, "top-left");
    ENUM_MAP(BAR_LOCATION, BL_TOP_CENTER, "top-center");
    ENUM_MAP(BAR_LOCATION, BL_TOP_RIGHT, "top-right");
    ENUM_MAP(BAR_LOCATION, BL_BOTTOM_LEFT, "bottom-left");
    ENUM_MAP(BAR_LOCATION, BL_BOTTOM_CENTER, "bottom-center");
    ENUM_MAP(BAR_LOCATION, BL_BOTTOM_RIGHT, "bottom-right");
    ...
    ENUM_MAP(QUICK_GUNS_MODE, QUICK_GUNS_DRAW_ONLY, "draw-only");
    ENUM_MAP(QUICK_GUNS_MODE, QUICK_GUNS_DRAW_AND_HOLSTER, "draw-and-holster");
    ...
    ENUM_MAP(TARGET_LOCK_MODE, TLM_FULL, "full-lock");
    ENUM_MAP(TARGET_LOCK_MODE, TLM_SEMI, "semi-lock");
    ENUM_MAP(TARGET_LOCK_MODE, TLM_NONE, "no-lock");

    ENUM_MAP(STAT_DETAIL_MODE, SDM_MINIMAL, "minimal");
    ENUM_MAP(STAT_DETAIL_MODE, SDM_DETAILED, "detailed");
    ENUM_MAP(STAT_DETAIL_MODE, SDM_FULL, "full");

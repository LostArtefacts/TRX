...
static __attribute__((constructor)) void M_Init(void)
{
    ...
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_TOP_LEFT, "top-left");
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_TOP_CENTER, "top-center");
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_TOP_RIGHT, "top-right");
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_BOTTOM_LEFT, "bottom-left");
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_BOTTOM_CENTER, "bottom-center");
    ENUM_MAP(BAR_LOCATION, BAR_LOCATION_BOTTOM_RIGHT, "bottom-right");

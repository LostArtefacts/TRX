...
REGISTER_OBJECT(O_KEY_HOLE_5, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_6, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_7, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_8, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_9, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_10, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_11, M_Setup)
REGISTER_OBJECT(O_KEY_HOLE_12, M_Setup)

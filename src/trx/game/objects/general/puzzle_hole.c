...
REGISTER_OBJECT(O_PUZZLE_HOLE_5, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_6, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_7, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_8, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_9, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_10, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_11, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_HOLE_12, M_SetupEmpty)
REGISTER_OBJECT(O_PUZZLE_DONE_5, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_6, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_7, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_8, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_9, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_10, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_11, M_SetupDone)
REGISTER_OBJECT(O_PUZZLE_DONE_12, M_SetupDone)

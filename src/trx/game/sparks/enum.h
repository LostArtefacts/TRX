...
typedef enum {
    ...
    SPARK_TYPE_UNKNOWN_5    = 35, // OG TR4 11
    SPARK_TYPE_UNKNOWN_6    = 36, // OG TR4 12
    SPARK_TYPE_UNKNOWN_7    = 37, // OG TR4 13
    SPARK_TYPE_UNKNOWN_8    = 38, // OG TR4 14
    SPARK_TYPE_UNKNOWN_9    = 39, // OG TR4 15
    SPARK_TYPE_UNKNOWN_10   = 40, // OG TR4 28
    SPARK_TYPE_UNKNOWN_11   = 41, // OG TR4 29
    SPARK_TYPE_UNKNOWN_12   = 42, // OG TR4 30
    SPARK_TYPE_UNKNOWN_13   = 43, // OG TR4 31
    SPARK_TYPE_UNKNOWN_14   = 44, // OG TR4 32
    // clang-format on
} SPARK_SPRITE_TYPE;

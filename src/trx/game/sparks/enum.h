...
typedef enum {
    SPARK_CONTEXT_DEFAULT,
    SPARK_CONTEXT_BLOOD,
    SPARK_CONTEXT_BREATH,
    SPARK_CONTEXT_BUBBLE,
    SPARK_CONTEXT_ELECTRICITY,
    SPARK_CONTEXT_EXPLOSION,
    SPARK_CONTEXT_FIRE,
    SPARK_CONTEXT_GAS,
    SPARK_CONTEXT_PARTICLE,
    SPARK_CONTEXT_PICKUP_AID,
    SPARK_CONTEXT_PLASMA,
    SPARK_CONTEXT_RICOCHET,
    SPARK_CONTEXT_SMOKE,
    SPARK_CONTEXT_SPLASH,
    SPARK_CONTEXT_WATER_MIST,
} SPARK_CONTEXT;

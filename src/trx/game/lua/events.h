...
typedef enum {
    ...
    LUA_EVENT_KEY_DOWN,
    LUA_EVENT_KEY_UP,
    LUA_EVENT_KEY_REPEAT,
    LUA_EVENT_BUTTON_DOWN,
    LUA_EVENT_BUTTON_UP,
    LUA_EVENT_TEXT_INPUT,
    LUA_EVENT_CONSOLE_LOG,
    LUA_EVENT_CONSOLE_CLEAR,
    LUA_EVENT_CONSOLE_OPEN,
    LUA_EVENT_CONSOLE_CLOSE,
    LUA_EVENT_UI_PAINT_OVER,
    LUA_EVENT_SHOW_PICKUP,
    LUA_EVENT_NUMBER_OF,
} LUA_EVENT_TYPE;

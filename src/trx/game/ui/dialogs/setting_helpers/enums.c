...
const UI_SETTINGS_ENUM_ENTRY UI_Settings_BackgroundStyleEnumEntries[] = {
    ...
    { BK_MONOCHROME_COOL, GS_ID(ENUM_BK_MONOCHROME_COOL) },
    { BK_MONOCHROME_WARM, GS_ID(ENUM_BK_MONOCHROME_WARM) },
    { -1, nullptr },
};

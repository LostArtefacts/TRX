...
typedef void (*UI_SETTINGS_TAB_DRAW_FOOTER_FUNC)(
    void *user_data, UI_SETTINGS_PHASE phase, float dialog_width);
...
typedef float (*UI_SETTINGS_TAB_GET_MIN_CONTENT_WIDTH_FUNC)(void *user_data);
...
typedef struct UI_SETTINGS_TAB_OPS {
    ...
    UI_SETTINGS_TAB_GET_MIN_CONTENT_WIDTH_FUNC get_min_content_width;

...
void SG_File_DumpInventory(JSON_WRITE_IO *const io)
{
    ...
    JSONW_WRITE(io, "pickup3", Inv_RequestItem(O_PICKUP_ITEM_3));
    JSONW_WRITE(io, "pickup4", Inv_RequestItem(O_PICKUP_ITEM_4));
    JSONW_WRITE(io, "quest5", Inv_RequestItem(O_QUEST_ITEM_5));
    JSONW_WRITE(io, "quest6", Inv_RequestItem(O_QUEST_ITEM_6));
    JSONW_WRITE(io, "puzzle5", Inv_RequestItem(O_PUZZLE_ITEM_5));
    JSONW_WRITE(io, "puzzle6", Inv_RequestItem(O_PUZZLE_ITEM_6));
    JSONW_WRITE(io, "puzzle7", Inv_RequestItem(O_PUZZLE_ITEM_7));
    JSONW_WRITE(io, "puzzle8", Inv_RequestItem(O_PUZZLE_ITEM_8));
    JSONW_WRITE(io, "puzzle9", Inv_RequestItem(O_PUZZLE_ITEM_9));
    JSONW_WRITE(io, "puzzle10", Inv_RequestItem(O_PUZZLE_ITEM_10));
    JSONW_WRITE(io, "puzzle11", Inv_RequestItem(O_PUZZLE_ITEM_11));
    JSONW_WRITE(io, "puzzle12", Inv_RequestItem(O_PUZZLE_ITEM_12));
    JSONW_WRITE(io, "key5", Inv_RequestItem(O_KEY_ITEM_5));
    JSONW_WRITE(io, "key6", Inv_RequestItem(O_KEY_ITEM_6));
    JSONW_WRITE(io, "key7", Inv_RequestItem(O_KEY_ITEM_7));
    JSONW_WRITE(io, "key8", Inv_RequestItem(O_KEY_ITEM_8));
    JSONW_WRITE(io, "key9", Inv_RequestItem(O_KEY_ITEM_9));
    JSONW_WRITE(io, "key10", Inv_RequestItem(O_KEY_ITEM_10));
    JSONW_WRITE(io, "key11", Inv_RequestItem(O_KEY_ITEM_11));
    JSONW_WRITE(io, "key12", Inv_RequestItem(O_KEY_ITEM_12));
    JSONW_WRITE(io, "puzzle1_combo1", Inv_RequestItem(O_PUZZLE_ITEM_1_COMBO_1));
    JSONW_WRITE(io, "puzzle1_combo2", Inv_RequestItem(O_PUZZLE_ITEM_1_COMBO_2));
    JSONW_WRITE(io, "puzzle2_combo1", Inv_RequestItem(O_PUZZLE_ITEM_2_COMBO_1));
    JSONW_WRITE(io, "puzzle2_combo2", Inv_RequestItem(O_PUZZLE_ITEM_2_COMBO_2));
    JSONW_WRITE(io, "puzzle3_combo1", Inv_RequestItem(O_PUZZLE_ITEM_3_COMBO_1));
    JSONW_WRITE(io, "puzzle3_combo2", Inv_RequestItem(O_PUZZLE_ITEM_3_COMBO_2));
    JSONW_WRITE(io, "puzzle4_combo1", Inv_RequestItem(O_PUZZLE_ITEM_4_COMBO_1));
    JSONW_WRITE(io, "puzzle4_combo2", Inv_RequestItem(O_PUZZLE_ITEM_4_COMBO_2));
    JSONW_WRITE(io, "puzzle5_combo1", Inv_RequestItem(O_PUZZLE_ITEM_5_COMBO_1));
    JSONW_WRITE(io, "puzzle5_combo2", Inv_RequestItem(O_PUZZLE_ITEM_5_COMBO_2));
    JSONW_WRITE(io, "puzzle6_combo1", Inv_RequestItem(O_PUZZLE_ITEM_6_COMBO_1));
    JSONW_WRITE(io, "puzzle6_combo2", Inv_RequestItem(O_PUZZLE_ITEM_6_COMBO_2));
    JSONW_WRITE(io, "puzzle7_combo1", Inv_RequestItem(O_PUZZLE_ITEM_7_COMBO_1));
    JSONW_WRITE(io, "puzzle7_combo2", Inv_RequestItem(O_PUZZLE_ITEM_7_COMBO_2));
    JSONW_WRITE(io, "puzzle8_combo1", Inv_RequestItem(O_PUZZLE_ITEM_8_COMBO_1));
    JSONW_WRITE(io, "puzzle8_combo2", Inv_RequestItem(O_PUZZLE_ITEM_8_COMBO_2));
    JSONW_WRITE(io, "key1_combo1", Inv_RequestItem(O_KEY_ITEM_1_COMBO_1));
    JSONW_WRITE(io, "key1_combo2", Inv_RequestItem(O_KEY_ITEM_1_COMBO_2));
    JSONW_WRITE(io, "key2_combo1", Inv_RequestItem(O_KEY_ITEM_2_COMBO_1));
    JSONW_WRITE(io, "key2_combo2", Inv_RequestItem(O_KEY_ITEM_2_COMBO_2));
    JSONW_WRITE(io, "key3_combo1", Inv_RequestItem(O_KEY_ITEM_3_COMBO_1));
    JSONW_WRITE(io, "key3_combo2", Inv_RequestItem(O_KEY_ITEM_3_COMBO_2));
    JSONW_WRITE(io, "key4_combo1", Inv_RequestItem(O_KEY_ITEM_4_COMBO_1));
    JSONW_WRITE(io, "key4_combo2", Inv_RequestItem(O_KEY_ITEM_4_COMBO_2));
    JSONW_WRITE(io, "key5_combo1", Inv_RequestItem(O_KEY_ITEM_5_COMBO_1));
    JSONW_WRITE(io, "key5_combo2", Inv_RequestItem(O_KEY_ITEM_5_COMBO_2));
    JSONW_WRITE(io, "key6_combo1", Inv_RequestItem(O_KEY_ITEM_6_COMBO_1));
    JSONW_WRITE(io, "key6_combo2", Inv_RequestItem(O_KEY_ITEM_6_COMBO_2));
    JSONW_WRITE(io, "key7_combo1", Inv_RequestItem(O_KEY_ITEM_7_COMBO_1));
    JSONW_WRITE(io, "key7_combo2", Inv_RequestItem(O_KEY_ITEM_7_COMBO_2));
    JSONW_WRITE(io, "key8_combo1", Inv_RequestItem(O_KEY_ITEM_8_COMBO_1));
    JSONW_WRITE(io, "key8_combo2", Inv_RequestItem(O_KEY_ITEM_8_COMBO_2));
    JSONW_WRITE(io, "pickup1_combo1", Inv_RequestItem(O_PICKUP_ITEM_1_COMBO_1));
    JSONW_WRITE(io, "pickup1_combo2", Inv_RequestItem(O_PICKUP_ITEM_1_COMBO_2));
    JSONW_WRITE(io, "pickup2_combo1", Inv_RequestItem(O_PICKUP_ITEM_2_COMBO_1));
    JSONW_WRITE(io, "pickup2_combo2", Inv_RequestItem(O_PICKUP_ITEM_2_COMBO_2));
    JSONW_WRITE(io, "pickup3_combo1", Inv_RequestItem(O_PICKUP_ITEM_3_COMBO_1));
    JSONW_WRITE(io, "pickup3_combo2", Inv_RequestItem(O_PICKUP_ITEM_3_COMBO_2));
    JSONW_WRITE(io, "pickup4_combo1", Inv_RequestItem(O_PICKUP_ITEM_4_COMBO_1));
    JSONW_WRITE(io, "pickup4_combo2", Inv_RequestItem(O_PICKUP_ITEM_4_COMBO_2));
    JSONW_WRITE(io, "lasersight", Inv_RequestItem(O_LASERSIGHT_ITEM));
    JSONW_WRITE(io, "binoculars", Inv_RequestItem(O_BINOCULARS_ITEM));
    JSONW_WRITE(io, "crowbar", Inv_RequestItem(O_CROWBAR_ITEM));
    JSONW_WRITE(io, "examine1", Inv_RequestItem(O_EXAMINE_ITEM_1));
    JSONW_WRITE(io, "examine2", Inv_RequestItem(O_EXAMINE_ITEM_2));
    JSONW_WRITE(io, "examine3", Inv_RequestItem(O_EXAMINE_ITEM_3));
    JSONW_WRITE(io, "waterskin1", Inv_RequestItem(O_WATERSKIN_1_EMPTY));
    JSONW_WRITE(io, "waterskin2", Inv_RequestItem(O_WATERSKIN_2_EMPTY));

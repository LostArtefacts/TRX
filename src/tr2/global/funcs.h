...
#define Lift_Control ((void __cdecl (*)(int16_t item_num))0x00435740)
#define Lift_FloorCeiling ((void __cdecl (*)(ITEM *item, int32_t x, int32_t y, int32_t z, int32_t *floor, int32_t *ceiling))0x00435820)
#define Lift_Floor ((void __cdecl (*)(ITEM *item, int32_t x, int32_t y, int32_t z, int32_t *height))0x004359A0)

...
void TombRaiderPatch::applyGraphicPatches()
{
    ...
    if (m_ub) {
        patch(0x4565EB, "0A", "FF"); // ｨ (Combinable Diaeresis/Umlaut)
        patch(0x4565ED, "06", "FF"); // ^ (Combinable Circumflex)
        patch(0x4565EE, "06", "FF"); // ｴ (Combinable Acute Accent)
        patch(0x4565F5, "10", "FF"); // ` (Combinable Grave Accent)
    } else {
        patch(0x456C23, "0A", "FF"); // ｨ (Combinable Diaeresis/Umlaut)
        patch(0x456C25, "06", "FF"); // ^ (Combinable Circumflex)
        patch(0x456C26, "06", "FF"); // ｴ (Combinable Acute Accent)

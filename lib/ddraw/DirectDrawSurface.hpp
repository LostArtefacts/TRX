...
public:
    ...
    HRESULT WINAPI Blt(LPRECT lpDestRect, LPDIRECTDRAWSURFACE lpDDSrcSurface,
        LPRECT lpSrcRect, DWORD dwFlags, LPDDBLTFX lpDDBltFx);
    HRESULT WINAPI BltBatch(
        LPDDBLTBATCH lpDDBltBatch, DWORD dwCount, DWORD dwFlags);
    HRESULT WINAPI BltFast(DWORD dwX, DWORD dwY,
    ...
    HRESULT WINAPI Lock(LPRECT lpDestRect, LPDDSURFACEDESC lpDDSurfaceDesc,
    ...
    HRESULT WINAPI Blt(LPRECT lpDestRect, LPDIRECTDRAWSURFACE2 lpDDSrcSurface,
    ...
    HRESULT WINAPI DeleteAttachedSurface(
        DWORD dwFlags, LPDIRECTDRAWSURFACE2 lpDDSurface); // updated in v2
    ...
    HRESULT WINAPI UpdateOverlayZOrder(
        DWORD dwFlags, LPDIRECTDRAWSURFACE2 lpDDSReference); // updated in v2
